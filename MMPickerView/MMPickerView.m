  ...
  [UIView animateWithDuration:0.3
                   ...
                   animations:^{
                     ...
                     if(completed && hidden){
                      ...
                      ///////////選完按done post使用者所選擇的class到資料庫
                      
                         //選擇的值
                         NSLog(@"%@",[self selectedObject]);
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  //PickerView Container with top bar
    if (view.frame.size.width == 320) {
        ...
        _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 250.0, 320.0, 250.0)];
        
    }else if (view.frame.size.width == 375){
        
        _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 250.0, 375.0, 250.0)];
        
    }else if (view.frame.size.width == 414){
        
        _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 280.0, 414.0, 280.0)];
  ...
  */
  ...
  //[_pickerViewBarButtonItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys: [UIFont fontWithName:@"Helvetica-Neue" size:23.0], UITextAttributeFont,nil] forState:UIControlStateNormal];
   ...
   //[_pickerDoneButton setTitleColor:buttonTextColor forState:UIControlStateNormal];
  ...
  //Add pickerView
    if (view.frame.size.width == 320) {
        ...
        _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, 44.0, 375.0, 216.0)];
        
    }else if (view.frame.size.width == 414){
        
        _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, 44.0, 414.0, 220.0)];
    }
